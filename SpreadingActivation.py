...
def main():
    ...
    try:
        ...
        # Escolhendo as sementes iniciais de acordo com a lista ordenada do PageRank.
        # Os valores que serão testados são 0.005 (0.5%),0.01(1%),0.05 (5%),0.1 (10%)
